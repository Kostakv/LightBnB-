...
//Selects certain user based on email
...
const getAllProperties = (options, limit = 10) => {
  let queryParams = [];
  let queryText = `SELECT properties.*, avg(property_reviews.rating) as average_rating
  FROM properties
...
//Adds the property to the database/website
